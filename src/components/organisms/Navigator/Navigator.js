    ...
    <div className="navigator__wrapper ">
      {isMenuOpen && (
        <div className="navigator__list navigator__list-mobile">
          <div className="navigator__list-mobile__inner" onClick={closeMenu}>
            <div className="mobile_menu mobile_menu-open" >
            ...
            <div className="navigator__list-mobile__inner-list" >
          ...
          <div className='navigator__list-mobile__background' onClick={closeMenu}></div>
        </div>
      )}
